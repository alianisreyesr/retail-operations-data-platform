...
The bundled synthetic batch contains ten source rows: eight accepted and two rejected. Automated tests verify reconciliation, revenue, margin, low-stock logic, and reject persistence.
